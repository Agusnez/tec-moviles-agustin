...
import us.example.entregable1.items.FavoritesFragment.OnFavListFragmentInteractionListener
...
class MyFavoritesRecyclerViewAdapter(
        ...
        private val mListener: OnFavListFragmentInteractionListener?)
    ...
    init {
        mOnClickListener = View.OnClickListener { v ->
            ...
            mListener?.onFavListFragmentInteraction(item)
        }

        mValues = mValues.filter { it.favorite }
    }
