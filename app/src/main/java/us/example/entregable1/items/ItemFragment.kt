...
class ItemFragment : Fragment() {
    ...
    var columnCount = DummyContent.COLUMNS
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = MyItemRecyclerViewAdapter(
                    Content.ITEMS.filter { it.dateOfPost.time > DummyContent.startDate.time && it.dateOfPost.time < DummyContent.endDate.time },
                    listener
                )
            }
        }
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is OnItemListFragmentInteractionListener) {
            listener = context
        } else {
    ...
    interface OnItemListFragmentInteractionListener {
        ...
        fun onItemListFragmentInteraction(item: Item?)
    }
